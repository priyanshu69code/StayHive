...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rooms', '0003_room_country_room_host_alter_room_checkout'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Amenities',
            fields=[
                ('abstractthings_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rooms.abstractthings')),
            ],
            options={
                'abstract': False,
            },
            bases=('rooms.abstractthings',),
        ),
        migrations.CreateModel(
            name='Facility',
            fields=[
